...
These disparate methodological efforts share another important
characteristic: their continued success depends on state-of-the art data
management. Novel quantitative tools demand a higher volume of network
data; novel collection techniques demand powerful data repositories;
novel inference tools demand easier integration between different types
of data, including but not limited to interactions, species traits,
taxonomy, occurrences, and local bioclimatic conditions. In short,
advancing the science of ecological networks requires us not only to
increase the volume of available data, but to pair these data with
...
interactions available. We seek to assess the utility of ecological
networks at the global scale to support synthesis research. Based on
temporal and spatial biases in the description of some types of
...
Tad says ``lots of stuff''. So do a lot of papers cited here (e.g.,
Delmas, Tylianakis, Pellissier, etc. etc.)
