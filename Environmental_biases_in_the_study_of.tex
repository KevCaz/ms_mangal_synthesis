...
in which species or organisms interact ({\textbf{???}}; Poisot et al.
2016c; Delmas et al. 2018), and recently there has been an explosion of
interest in their dynamics across large temporal scales (Tylianakis \&
...
Europe (\xrefname{fig.}\cref{fig:spatial}). While this can to some
